...
Normal cells are stable; malignent cells are not.

Instability is generated by chromosomal translocations, amplifications, chromosome segregation errors, telomere disfunction, loss of DNA repair processes.

Instability can be random or non random. It gets caused by defects in caretaker genes, e.g. BRCA1.
